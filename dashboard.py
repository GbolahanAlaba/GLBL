...
InfVD = Button(Frame1, text='Day', font=('roboto', 10, 'bold'), bd=0, cursor='hand2', activebackground='green', activeforeground='white', command=InflowD)
InfVD.place(x=23, y=70)
DivLine = Frame(Frame1, height=15, width=1, bg='red')
DivLine.place(x=60, y=75)
InfVW = Button(Frame1, text='Week', font=('roboto', 10, 'bold'), bd=0, cursor='hand2', activebackground='green', activeforeground='white', command=InflowW)
InfVW.place(x=70, y=70)
DivLine = Frame(Frame1, height=15, width=1, bg='red')
DivLine.place(x=120, y=75)
InfVM = Button(Frame1, text='Month', font=('roboto', 10, 'bold'), bd=0, cursor='hand2', activebackground='green', activeforeground='white', command=InflowM)
InfVM.place(x=127, y=70)
...
OutfVD = Button(Frame1, text='Day', font=('roboto', 10, 'bold'), bd=0, cursor='hand2', activebackground='black', activeforeground='white', command=OutflowD)
OutfVD.place(x=205, y=70)
DivLine = Frame(Frame1, height=15, width=1, bg='red')
DivLine.place(x=239, y=75)
OutfVW = Button(Frame1, text='Week', font=('roboto', 10, 'bold'), bd=0, cursor='hand2', activebackground='black', activeforeground='white', command=OutflowW)
OutfVW.place(x=248, y=70)
DivLine = Frame(Frame1, height=15, width=1, bg='red')
DivLine.place(x=300, y=75)
OutfVM = Button(Frame1, text='Month', font=('roboto', 10, 'bold'), bd=0, cursor='hand2', activebackground='black', activeforeground='white', command=OutflowM)
OutfVM.place(x=308, y=70)
...
ExpVD = Button(Frame1, text='Day', font=('roboto', 10, 'bold'), bd=0, cursor='hand2', activebackground='#d11c03', activeforeground='white', command=ExpD)
ExpVD.place(x=387, y=70)
DivLine = Frame(Frame1, height=15, width=1, bg='red')
DivLine.place(x=422, y=75)
ExpVW = Button(Frame1, text='Week', font=('roboto', 10, 'bold'), bd=0, cursor='hand2', activebackground='#d11c03', activeforeground='white', command=ExpW)
ExpVW.place(x=432, y=70)
DivLine = Frame(Frame1, height=15, width=1, bg='red')
DivLine.place(x=481, y=75)
ExpVM = Button(Frame1, text='Month', font=('roboto', 10, 'bold'), bd=0, cursor='hand2', activebackground='#d11c03', activeforeground='white', command=ExpM)
ExpVM.place(x=490, y=70)
...
BalVD = Button(Frame1, text='Day', font=('roboto', 10, 'bold'), bd=0, cursor='hand2', activebackground='green', activeforeground='white', command=BalD)
BalVD.place(x=586, y=70)
DivLine = Frame(Frame1, height=15, width=1, bg='red')
DivLine.place(x=623, y=75)
BalVW = Button(Frame1, text='Week', font=('roboto', 10, 'bold'), bd=0, cursor='hand2', activebackground='green', activeforeground='white', command=BalW)
BalVW.place(x=630, y=70)
DivLine = Frame(Frame1, height=15, width=1, bg='red')
DivLine.place(x=680, y=75)
BalVM = Button(Frame1, text='Month', font=('roboto', 10, 'bold'), bd=0, cursor='hand2', activebackground='green', activeforeground='white', command=BalM)
BalVM.place(x=685, y=70)
